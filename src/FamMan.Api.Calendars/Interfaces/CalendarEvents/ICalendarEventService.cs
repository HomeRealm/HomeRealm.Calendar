...
public interface ICalendarEventService
{
  ...
  public Task<(string status, CalendarEventResponseDto? updatedCalendarEvent)> UpdateCalendarEventAsync(CalendarEventRequestDto dto, Guid id, CancellationToken ct);
