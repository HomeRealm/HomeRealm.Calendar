...
namespace HomeRealm.Api.Calendars.Interfaces.CalendarEvents;
...
public interface ICalendarEventService
{
  ...
  public Task<List<CalendarEventResponseDto>> GetCalendarEventsForCalendarAsync(Guid calendarId, CancellationToken ct);
