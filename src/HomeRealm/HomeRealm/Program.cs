using HomeRealm.Client.Pages;
using HomeRealm.Components;
...
builder.Configuration
    ...
    .AddEnvironmentVariables("HomeRealm_")
    .AddCommandLine(args);
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(HomeRealm.Client._Imports).Assembly);
app.MapReverseProxy();
